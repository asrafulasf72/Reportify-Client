    ...
    return (
        <div className="drawer lg:drawer-open">
            ...
            <div className="drawer-content">
                {/* Navbar */}
                <nav className="navbar w-full bg-[#B7E5CD]">
            ...
            <div className="drawer-side is-drawer-close:overflow-visible">
                ...
                <div className="flex min-h-full flex-col items-start bg-[#305669] is-drawer-close:w-14 is-drawer-open:w-64">
                    ...
                    <ul className="menu w-full grow text-white">
                        ...
                        }
                        {
                            role === 'admin' && <>
                                ...
                                <li>
                                    <Link to='/dashboard/payment-page' className="is-drawer-close:tooltip is-drawer-close:tooltip-right" data-tip="Payment Page">
                                        {/* Home icon */}
